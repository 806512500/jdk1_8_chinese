...
/**
 * 该类定义了 {@code KeyFactory} 类的 <i>服务提供者接口</i> (<b>SPI</b>)。
 * 所有该类中的抽象方法都必须由每个希望为特定算法提供密钥工厂实现的加密服务提供者实现。
 *
