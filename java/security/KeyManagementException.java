...
/**
 * 这是所有与密钥管理操作相关的通用密钥管理异常。开发人员可以创建的
...
public class KeyManagementException extends KeyException {
    ...
    /**
     * 构造一个没有详细消息的 KeyManagementException。详细消息是
     * 一个描述此特定异常的字符串。
     */
    public KeyManagementException() {
     ...
     /**
     * 使用指定的详细消息构造一个 KeyManagementException。详细消息是
     * 一个描述此特定异常的字符串。
     *
     * @param msg 详细消息。
     */
   public KeyManagementException(String msg) {
    ...
    /**
     * 使用指定的详细消息和原因创建一个 {@code KeyManagementException}。
     *
     ...
     * 创建一个 {@code KeyManagementException}（通常包含 {@code cause} 的类和详细消息）。
     *
     * @param cause 原因（稍后通过 {@link #getCause()} 方法检索）。允许为 {@code null}，
     *        表示原因不存在或未知。
     * @since 1.5
