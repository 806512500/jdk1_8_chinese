...
/*
 * 版权所有 (c) 1997, 2011, Oracle 和/或其附属公司。保留所有权利。
...
/**
 * UnresolvedPermissionCollection 存储一组 UnresolvedPermission 权限。
 *
...
implements java.io.Serializable
{
    ...
    /**
     * 向此 UnresolvedPermissionCollection 添加一个权限。
     * 哈希的键是未解析权限的类型（类）名称。
     *
    ...
    // 需要与早期版本保持序列化互操作性，
    // 这些版本具有可序列化的字段：
    // private Hashtable permissions; // 键是类型
