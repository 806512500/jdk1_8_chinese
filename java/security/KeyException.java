...
public class KeyException extends GeneralSecurityException {
    ...
    /**
     * 构造一个没有详细消息的 KeyException。详细消息是一个描述此特定异常的字符串。
     */
    public KeyException() {
        super();
    }
    ...
    /**
     * 使用指定的详细消息构造一个 KeyException。详细消息是一个描述此特定异常的字符串。
     *
     * @param msg 详细消息。
     */
    ...
    /**
     * 使用指定的原因创建一个 {@code KeyException}，详细消息为 {@code (cause==null ? null : cause.toString())}
