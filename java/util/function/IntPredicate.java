...
/**
 * 表示一个接受一个 {@code int} 类型参数的布尔值函数。这是 {@link Predicate} 的 {@code int} 类型特化版本。
 *
...
public interface IntPredicate {
    ...
    /**
     * 返回一个表示此谓词与另一个谓词的短路逻辑 AND 的组合谓词。在评估组合谓词时，如果此谓词为 {@code false}，则不评估 {@code other} 谓词。
     *
     * <p>在评估任一谓词时抛出的任何异常都会传递给调用者；如果评估此谓词时抛出异常，则不会评估 {@code other} 谓词。
     *
     * @param other 与本谓词进行逻辑 AND 操作的谓词
    ...
    /**
     * 返回一个表示此谓词与另一个谓词的短路逻辑 OR 的组合谓词。在评估组合谓词时，如果此谓词为 {@code true}，则不评估 {@code other} 谓词。
     *
     * <p>在评估任一谓词时抛出的任何异常都会传递给调用者；如果评估此谓词时抛出异常，则不会评估 {@code other} 谓词。
     *
     * @param other 与本谓词进行逻辑 OR 操作的谓词
