...
public interface Predicate<T> {
    ...
    /**
     * 返回一个复合谓词，表示此谓词和另一个谓词的短路逻辑 AND。在评估复合谓词时，如果此谓词为 {@code false}，则不评估 {@code other} 谓词。
     *
     * <p>在评估任一谓词时抛出的任何异常都会传递给调用者；如果评估此谓词时抛出异常，则不会评估 {@code other} 谓词。
     *
     * @param other 将与本谓词逻辑 AND 的谓词
     * @return 一个复合谓词，表示此谓词和 {@code other} 谓词的短路逻辑 AND
    ...
    /**
     * 返回一个复合谓词，表示此谓词和另一个谓词的短路逻辑 OR。在评估复合谓词时，如果此谓词为 {@code true}，则不评估 {@code other} 谓词。
     *
     * <p>在评估任一谓词时抛出的任何异常都会传递给调用者；如果评估此谓词时抛出异常，则不会评估 {@code other} 谓词。
     *
     * @param other 将与本谓词逻辑 OR 的谓词
     * @return 一个复合谓词，表示此谓词和 {@code other} 谓词的短路逻辑 OR
     * @throws NullPointerException 如果 other 为 null
     */
     ...
     *
     * @param <T> 谓词参数的类型
     * @param targetRef 用于比较相等性的对象引用，可以为 {@code null}
