...
class JumboEnumSet<E extends Enum<E>> extends EnumSet<E> {
    ...
    /**
     * 此集合的位向量表示。第 j 个元素的第 i 位表示 universe[64*j + i]
     * 是否存在于此集合中。
     */
    ...
    /**
     * 返回一个迭代器，遍历此集合中的元素。迭代器按元素的<i>自然顺序</i>
     * （即枚举常量声明的顺序）遍历。返回的迭代器是一个“弱一致性”迭代器，
     * 永远不会抛出 {@link ConcurrentModificationException}。
     *
     ...
     *
     * @param c 要添加到此集合的集合
     * @return 如果调用后此集合已更改，则返回 <tt>true</tt>
    ...
    /**
     * 将指定的对象与此集合进行相等性比较。如果给定的对象也是一个集合，两个集合的大小相同，并且给定集合的每个成员都包含在此集合中，则返回 <tt>true</tt>。
     *
     * @param o 要与此集合进行相等性比较的对象
     * @return 如果指定的对象等于此集合，则返回 <tt>true</tt>
     */
