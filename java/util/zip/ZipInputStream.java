...
/**
 * 此类实现了一个用于读取 ZIP 文件格式文件的输入流过滤器。支持压缩和未压缩的条目。
 *
...
class ZipInputStream extends InflaterInputStream implements ZipConstants {
     ...
     *        <a href="package-summary.html#lang_encoding"> 语言编码位</a> 已设置，则忽略此字符集）。
     *
     * @since 1.7
     */
     ...
     * @param len 最大读取字节数
     * @return 实际读取的字节数，或如果到达条目末尾则返回 -1
    ...
    private ZipEntry readLOC() throws IOException {
        ...
        readFully(b, 0, len);
        // 如果 EFS 位为 ON，即使字符集不是 UTF-8，也强制使用 UTF-8
