...
public final class DataBufferFloat extends DataBuffer {
    ...
    /**
     * 构造一个具有指定大小的基于 <code>float</code> 的 <code>DataBuffer</code>。
     *
     * @param size 数据缓冲区中的元素数量。
     */
    ...
    /**
     * 构造一个具有指定数量的银行，所有银行都具有指定大小的基于 <code>float</code> 的 <code>DataBuffer</code>。
     *
     * @param size 每个银行中的元素数量。
     * @param numBanks 数据缓冲区中的银行数量。
     */
    ...
    /**
     * 构造一个基于指定数据数组的基于 <code>float</code> 的 <code>DataBuffer</code>。 只有前 <code>size</code> 个元素可供此 <code>DataBuffer</code> 使用。 数组必须足够大以容纳 <code>size</code> 个元素。
     * <p>
     * 请注意，通过此构造函数创建的 <code>DataBuffer</code> 对象可能与某些实现使用的 <a href="#optimizations">性能优化</a>（如将关联图像缓存在视频内存中）不兼容。
     *
     * @param dataArray 用作此 <code>DataBuffer</code> 的第一个也是唯一一个银行的 <code>float</code> 数组。
     * @param size 数组中要使用的元素数量。
     */
    ...
    /**
     * 构造一个基于指定数据数组的基于 <code>float</code> 的 <code>DataBuffer</code>。 只有 <code>offset</code> 和 <code>offset + size - 1</code> 之间的元素可供此 <code>DataBuffer</code> 使用。 数组必须足够大以容纳 <code>offset + size</code> 个元素。
     * <p>
     * 请注意，通过此构造函数创建的 <code>DataBuffer</code> 对象可能与某些实现使用的 <a href="#optimizations">性能优化</a>（如将关联图像缓存在视频内存中）不兼容。
     *
     * @param dataArray 用作此 <code>DataBuffer</code> 的第一个也是唯一一个银行的 <code>float</code> 数组。
     * @param size 数组中要使用的元素数量。
     * @param offset 数组中第一个将被使用的元素的偏移量。
     */
    ...
    /**
     * 构造一个基于指定数据数组的基于 <code>float</code> 的 <code>DataBuffer</code>。 只有每个数组的前 <code>size</code> 个元素可供此 <code>DataBuffer</code> 使用。 银行数量将等于 <code>dataArray.length</code>。
     * <p>
     * 请注意，通过此构造函数创建的 <code>DataBuffer</code> 对象可能与某些实现使用的 <a href="#optimizations">性能优化</a>（如将关联图像缓存在视频内存中）不兼容。
     *
     * @param dataArray 用作此 <code>DataBuffer</code> 的银行的 <code>float</code> 数组数组。
     * @param size 每个数组中要使用的元素数量。
     */
    public DataBufferFloat(float dataArray[][], int size) {
    ...
    /**
     * 构造一个基于指定数据数组、大小和每个银行偏移量的基于 <code>float</code> 的 <code>DataBuffer</code>。 银行数量等于 <code>dataArray.length</code>。 每个数组的大小必须至少为 <code>size</code> 加上相应的偏移量。 偏移量数组中必须有每个数据数组的条目。
     * <p>
     * 请注意，通过此构造函数创建的 <code>DataBuffer</code> 对象可能与某些实现使用的 <a href="#optimizations">性能优化</a>（如将关联图像缓存在视频内存中）不兼容。
     *
     * @param dataArray 用作此 <code>DataBuffer</code> 的银行的 <code>float</code> 数组数组。
     ...
     * <p>
     * 请注意，调用此方法可能导致此 <code>DataBuffer</code> 对象与某些实现使用的 <a href="#optimizations">性能优化</a>（如将关联图像缓存在视频内存中）不兼容。
     *
    ...
    /**
     * 从指定银行返回请求的数据数组元素作为 <code>int</code>。
     *
     * @param bank 银行编号。
     * @param i 所需的数据数组元素。
     *
    ...
    /**
     * 从指定银行返回请求的数据数组元素作为 <code>float</code>。
     *
     * @param bank 银行编号。
     * @param i 所需的数据数组元素。
     *
    ...
    /**
     * 从指定银行返回请求的数据数组元素作为 <code>double</code>。
     *
     * @param bank 银行编号。
     * @param i 所需的数据数组元素。
     *
