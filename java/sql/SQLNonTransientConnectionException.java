...
/**
 * {@link SQLException} 的子类，用于 SQLState 类值为 '<i>08</i>' 或供应商指定条件的情况。这表示失败的连接操作如果在未纠正失败原因的情况下重试，将不会成功。
 * <p>
...
public class SQLNonTransientConnectionException extends java.sql.SQLNonTransientException {
        ...
        /**
         * 构造一个带有给定 <code>reason</code> 的 <code>SQLNonTransientConnectionException</code> 对象。 <code>SQLState</code>
        ...
        /**
         * 构造一个带有给定 <code>reason</code> 和 <code>SQLState</code> 的 <code>SQLNonTransientConnectionException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以通过调用
        ...
        /**
         * 构造一个带有给定 <code>reason</code>、<code>SQLState</code> 和 <code>vendorCode</code> 的 <code>SQLNonTransientConnectionException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以通过调用
         * {@link Throwable#initCause(java.lang.Throwable)} 方法进行初始化。
         * <p>
        ...
        /**
     * 构造一个带有给定 <code>cause</code> 的 <code>SQLNonTransientConnectionException</code> 对象。
    ...
    /**
     * 构造一个带有给定
     * <code>reason</code> 和 <code>cause</code> 的 <code>SQLTransientException</code> 对象。
    ...
    /**
     * 构造一个带有给定
     * <code>reason</code>、<code>SQLState</code> 和 <code>cause</code> 的 <code>SQLNonTransientConnectionException</code> 对象。
     * 供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     ...
     * 和 <code>cause</code> 的 <code>SQLNonTransientConnectionException</code> 对象。
     * <p>
     * @param reason 异常的描述
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     * @param vendorCode 数据库供应商特定的异常代码
