...
/**
 * 当 SQLState 类值为 '<i>28</i>' 或在供应商指定的条件下抛出的 {@link SQLException} 子类。这表明在连接建立期间提供的授权凭证无效。
 * <p>
...
public class SQLInvalidAuthorizationSpecException extends SQLNonTransientException {
     ...
     * <code>reason</code> 如果 <code>cause==null</code> 则初始化为 <code>null</code>，如果 <code>cause!=null</code> 则初始化为 <code>cause.toString()</code>。
         * <p>
     * @param cause 该 <code>SQLException</code> 的根本原因（稍后通过 <code>getCause()</code> 方法检索）；可能是 null，表示原因不存在或未知。
     * @since 1.6
         */
    ...
    /**
     * 构造一个带有给定
     * <code>reason</code> 和 <code>cause</code> 的 <code>SQLInvalidAuthorizationSpecException</code> 对象。
     * <code>SQLState</code> 初始化为 <code>null</code>
     * 供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
     * @param cause 该 <code>SQLException</code> 的根本原因（稍后通过 <code>getCause()</code> 方法检索）；可能是 null，表示原因不存在或未知。
    ...
    /**
     * 构造一个带有给定
     * <code>reason</code>，<code>SQLState</code> 和 <code>cause</code> 的 <code>SQLInvalidAuthorizationSpecException</code> 对象。
     * 供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     ...
     * 和 <code>cause</code> 的 <code>SQLInvalidAuthorizationSpecException</code> 对象。
     * <p>
     * @param reason 异常的描述
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     * @param vendorCode 数据库供应商特定的异常代码
