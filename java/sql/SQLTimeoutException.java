 ...
 * {@code DataSource.setLoginTimeout}、{@code XADataSource.setLoginTimeout} 指定的超时时间已过期时抛出的 {@link SQLException} 子类。
 * <P>此异常不对应于标准的 SQLState。
 *
 * @since 1.6
 */
...
public class SQLTimeoutException extends SQLTransientException {
        ...
        /**
         * 构造一个带有给定 <code>reason</code> 和 <code>SQLState</code> 的 <code>SQLTimeoutException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以通过调用
        ...
        /**
         * 构造一个带有给定 <code>reason</code>、<code>SQLState</code> 和 <code>vendorCode</code> 的 <code>SQLTimeoutException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以通过调用
         * {@link Throwable#initCause(java.lang.Throwable)} 方法随后初始化。
         * <p>
    ...
    /**
     * 构造一个带有给定 <code>reason</code> 和 <code>cause</code> 的 <code>SQLTimeoutException</code> 对象。
     * <code>SQLState</code> 初始化为 <code>null</code>，供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
     * @param cause 该 <code>SQLException</code> 的根本原因（稍后通过 <code>getCause()</code> 方法检索）；可以为 null，表示原因不存在或未知。
    ...
    /**
     * 构造一个带有给定 <code>reason</code>、<code>SQLState</code> 和 <code>cause</code> 的 <code>SQLTimeoutException</code> 对象。
     * 供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
    ...
    /**
     * 构造一个带有给定 <code>reason</code>、<code>SQLState</code>、<code>vendorCode</code> 和 <code>cause</code> 的 <code>SQLTimeoutException</code> 对象。
     * <p>
     * @param reason 异常的描述
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     * @param vendorCode 数据库供应商特定的异常代码
