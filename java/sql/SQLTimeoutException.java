...
/**
 * <P>当由 {@code Statement.setQueryTimeout}、{@code DriverManager.setLoginTimeout}、
 * {@code DataSource.setLoginTimeout}、{@code XADataSource.setLoginTimeout} 指定的超时时间已过期时，
 * 抛出的 {@link SQLException} 子类。
 * <P>此异常不对应于标准 SQLState。
 *
 * @since 1.6
 */
...
public class SQLTimeoutException extends SQLTransientException {
         ...
         * <code>reason</code>、<code>SQLState</code> 初始化为 <code>null</code>，
         * 供应商代码初始化为 0。
         *
        ...
        /**
         * 构造一个带有给定 <code>reason</code> 的 <code>SQLTimeoutException</code> 对象。
        ...
        /**
         * 构造一个带有给定 <code>reason</code> 和 <code>SQLState</code> 的
         * <code>SQLTimeoutException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以随后通过调用
        ...
        /**
         * 构造一个带有给定 <code>reason</code>、<code>SQLState</code> 和
         * <code>vendorCode</code> 的 <code>SQLTimeoutException</code> 对象。
         *
         * <code>cause</code> 未初始化，可以随后通过调用
         * {@link Throwable#initCause(java.lang.Throwable)} 方法进行初始化。
         * <p>
    ...
    /**
     * 构造一个带有给定 <code>cause</code> 的 <code>SQLTimeoutException</code> 对象。
     * <code>SQLState</code> 初始化为 <code>null</code>，供应商代码初始化为 0。
     * <code>reason</code> 如果 <code>cause==null</code> 则初始化为 <code>null</code>，
     * 如果 <code>cause!=null</code> 则初始化为 <code>cause.toString()</code>。
     * <p>
     * @param cause 此 <code>SQLException</code> 的根本原因（通过 <code>getCause()</code> 方法稍后检索）；可以为 null，表示原因不存在或未知。
     * @since 1.6
     */
    ...
    /**
     * 构造一个带有给定 <code>reason</code> 和 <code>cause</code> 的
     * <code>SQLTimeoutException</code> 对象。
     * <code>SQLState</code> 初始化为 <code>null</code>，供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
    ...
    /**
     * 构造一个带有给定 <code>reason</code>、<code>SQLState</code> 和 <code>cause</code> 的
     * <code>SQLTimeoutException</code> 对象。
     * 供应商代码初始化为 0。
     * <p>
     * @param reason 异常的描述。
    ...
    /**
     * 构造一个带有给定 <code>reason</code>、<code>SQLState</code>、<code>vendorCode</code>
     * 和 <code>cause</code> 的 <code>SQLTimeoutException</code> 对象。
     * <p>
     * @param reason 异常的描述
     * @param SQLState 识别异常的 XOPEN 或 SQL:2003 代码
     * @param vendorCode 数据库供应商特定的异常代码
