...
public enum JDBCType implements SQLType {
    ...
    NULL(Types.NULL),
    /**
     * 表示 SQL 类型是数据库特定的，并映射到可以通过 getObject 和 setObject 方法访问的 Java 对象。
     */
    OTHER(Types.OTHER),
    /**
     * 表示 SQL 类型是数据库特定的，并映射到可以通过 getObject 和 setObject 方法访问的 Java 对象。
    ...
    /**
     * JDBCType 的 Integer 值。它映射到 {@code Types.java} 中的值。
     */
    private Integer type;

    /**
     * 构造函数，用于指定此数据类型的 {@code Types} 中的数据类型值。
     * @param type 此数据类型的 {@code Types} 中的值
     */
    ...
    /**
     * 返回支持此数据类型的供应商名称。
     * @return 此数据类型的供应商名称，对于 {@code JDBCType}，供应商名称为 {@literal java.sql}。
     */
    ...
    /**
     * 返回数据类型的供应商特定类型编号。
     * @return 一个表示数据类型的 Integer。对于 {@code JDBCType}，该值将与 {@code Types} 中的数据类型的值相同。
     */
