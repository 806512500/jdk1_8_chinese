 ...
 * 一个到网络套接字的通道。
 *
 * <p> 实现此接口的通道是一个到网络套接字的通道。{@link #bind(SocketAddress) bind} 方法用于将套接字绑定到一个本地 {@link SocketAddress 地址}，{@link #getLocalAddress()
 * getLocalAddress} 方法返回套接字绑定到的地址，而 {@link #setOption(SocketOption,Object) setOption} 和 {@link
    ...
    extends Channel
{
     ...
     *
     * @param   local
     *          要绑定的套接字地址，或 {@code null} 以将套接字绑定到自动分配的套接字地址
     *
     * @return  本通道
     *
     ...
     *
     * @return  套接字绑定到的套接字地址，或如果通道的套接字未绑定则返回 {@code null}
     *
     * @throws  ClosedChannelException
     *          如果通道已关闭
     * @throws  IOException
     ...
     *          套接字选项
     * @param   value
     *          套接字选项的值。对于某些套接字选项，值为 {@code null} 可能是有效的。
     *
     * @return  本通道
     *
     ...
     *          套接字选项
     *
     * @return  套接字选项的值。对于某些套接字选项，值为 {@code null} 可能是有效的。
     *
     * @throws  UnsupportedOperationException
     *          如果此通道不支持该套接字选项
     * @throws  ClosedChannelException
