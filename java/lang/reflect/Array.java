 ...
 *
 * <p>{@code Array} 允许在获取或设置操作期间发生扩展转换，但如果发生缩小转换，则会抛出 {@code IllegalArgumentException}。
 *
...
class Array {
     ...
     * @exception NullPointerException 如果指定的对象为 null
     * @exception IllegalArgumentException 如果指定的对象不是数组，或者索引元素不能通过身份或扩展转换转换为返回类型
     * @exception ArrayIndexOutOfBoundsException 如果指定的 {@code index} 参数为负数，或者它大于或等于指定数组的长度
     * @see Array#get
     */
    ...
    /**
     * 将指定数组对象中索引组件的值设置为指定的新值。如果数组具有原始组件类型，新值将首先自动拆箱。
     * @param array 数组
     * @param index 数组中的索引
     * @param value 索引组件的新值
     * @exception NullPointerException 如果指定的对象参数为 null
     * @exception IllegalArgumentException 如果指定的对象参数不是数组，或者数组组件类型为原始类型且拆箱转换失败
     * @exception ArrayIndexOutOfBoundsException 如果指定的 {@code index} 参数为负数，或者它大于或等于指定数组的长度
     */
    public static native void set(Object array, int index, Object value)
        throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
                ...
                /**
     * 设置指定数组对象的索引组件的值为指定的 {@code boolean} 值。
     * @param array 数组
     * @param index 数组中的索引
     * @param z 索引组件的新值
     * @exception NullPointerException 如果指定的对象参数为 null
     * @exception IllegalArgumentException 如果指定的对象参数不是数组，或者指定的值不能通过身份或原始类型扩展转换转换为底层数组的组件类型
     * @exception ArrayIndexOutOfBoundsException 如果指定的 {@code index} 参数为负数，或者大于或等于指定数组的长度
     * @see Array#set
     */
    ...
    /**
     * 设置指定数组对象的索引组件的值为指定的 {@code byte} 值。
     * @param array 数组
     * @param index 数组中的索引
     * @param b 索引组件的新值
     * @exception NullPointerException 如果指定的对象参数为 null
